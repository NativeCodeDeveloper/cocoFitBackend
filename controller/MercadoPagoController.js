        ...
        const resp = await fetch("https://api.brevo.com/v3/smtp/email", {
            ...
            body: JSON.stringify({
                ...
                htmlContent: `
                    ...
                    <p>Este es el comprobante de tu compra realizada en <strong>Macar Repuestos</strong>.</p>
                    ...
                    <p>Ante cualquier duda sobre tu compra, puedes responder a este correo.</p>
                `,
            }),
        });
    ...
    try {
        const resp = await fetch("https://api.brevo.com/v3/smtp/email", {
            ...
            body: JSON.stringify({
                ...
                to: [
                    { email: CORREO_RECEPTOR, name: "Dueño Macar Repuestos" },
                    { email: "contacto@nativecode.cl", name: "NativeCode" },
                ],
                replyTo: {
                    email: "contacto@nativecode.cl",
                ...
                htmlContent: `
                    <h2>Se ha realizado una nueva compra a través de ProSuite.</h2>
